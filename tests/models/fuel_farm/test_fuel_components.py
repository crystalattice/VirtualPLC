...
class TestGate3TankLevels:
    @classmethod
    def setup_class(cls):
        ffc.tank2.tank_level = 18.0
        fff.change_tank_level(ffc.tank2, ffc.tank2.tank_level)
        fff.gate1_open()
        fff.gate2_open()
        fff.gate3_open()
        fff.gate4_open()
