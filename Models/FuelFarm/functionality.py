...
def pump2_on():
    ...
    ffc.pump2.outlet_pressure = ffc.gate8.press_in = 50
    ffc.gate8.flow_in = ffc.pump2.flow + ffc.pump3.flow
...
def pump3_on():
    ...
    ffc.pump3.outlet_pressure = ffc.gate8.press_in = 50
    ffc.gate8.flow_in = ffc.pump3.flow + ffc.pump2.flow
